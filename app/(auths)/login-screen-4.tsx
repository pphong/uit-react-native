...
export default function TabLogin4Screen() {
  const sendcode = () => {
    console.log("sendcode");
    router.push("/(auths)/login-screen-3");
  };
    ...
    <>
      <View style={styles.loginScreen}>
        <View style={styles.viewflexCol}>
          <Link href="/(auths)/login-screen-2">
            <IconSymbol
              size={32}
              color="#5C46CC"
              name="arrow.backward"
          ...
          >
            ...
            <Button
              buttonTextStyle={styles.whiteText}
              customStyle={[styles.buttonCustom, styles.fbBtn]}
              label="Login With Facebook"
              key={"loginFb"}
            ></Button>
          </View>
          <Text style={styles.loginPhone}>
            <Link href="/(auths)/login-screen-2">Sign up with E-mail</Link>
          </Text>

          <Text style={[styles.whiteText, styles.marginAuto, styles.marginTop30]}>
            By creating an account you agree with our{" "}
            <Link style={styles.loginPhone} href="/(auths)/login-screen-2">
              Term of policy
            </Link>
          </Text>
        </View>
